...
/*   Updated: 2026/07/09 18:27:30 by prashres         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**split_check(char **splitted, char **argv, t_stacks *data,
	t_ptr_b_f ptr)
{
...
static int	pars_args_helper(char **splitted, char **argv, t_stacks *data,
	t_ptr_b_f ptr)
{
	t_node	*new;
	int		i;
